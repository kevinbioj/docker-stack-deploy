...
LABEL maintainer="kitconcept GmbH <info@kitconcept.com>" \
      ...
      org.opencontainers.image.source="https://github.com/kevinbioj/docker-stack-deploy" \
      org.label-schema.docker.cmd="docker run -rm -v "${PWD}":/github/workspace ghcr.io/kevinbioj/docker-stack-deploy"
